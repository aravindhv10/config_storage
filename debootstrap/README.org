...
#+begin_src conf :tangle ./debian_stable.list
  ...
  deb-src [trusted=yes] file:///repo/everything/apt-mirror/MY_MIRRORS/DEBIAN/dists/stable/contrib/source/Sources ./
  deb-src [trusted=yes] file:///repo/everything/apt-mirror/MY_MIRRORS/DEBIAN/dists/stable/main/source/Sources ./
  deb-src [trusted=yes] file:///repo/everything/apt-mirror/MY_MIRRORS/DEBIAN/dists/stable/non-free-firmware/source/Sources ./
  deb-src [trusted=yes] file:///repo/everything/apt-mirror/MY_MIRRORS/DEBIAN/dists/stable/non-free/source/Sources ./
#+end_src
...
#+begin_src conf :tangle ./debian_stable_backports.list
  ...
  deb-src [trusted=yes] file:///repo/everything/apt-mirror/MY_MIRRORS/DEBIAN/dists/stable-backports/contrib/source/Sources ./
  deb-src [trusted=yes] file:///repo/everything/apt-mirror/MY_MIRRORS/DEBIAN/dists/stable-backports/main/source/Sources ./
  deb-src [trusted=yes] file:///repo/everything/apt-mirror/MY_MIRRORS/DEBIAN/dists/stable-backports/non-free-firmware/source/Sources ./
  deb-src [trusted=yes] file:///repo/everything/apt-mirror/MY_MIRRORS/DEBIAN/dists/stable-backports/non-free/source/Sources ./
#+end_src
...
*** COMMENT Install root fs
#+begin_src sh :shebang #!/bin/bash :results output :tangle ./install.sh
  install_deb_testing
#+end_src

*** COMMENT Mount important filesystems
#+begin_src sh :shebang #!/bin/bash :results output :tangle ./install.sh
  do_bind_all
#+end_src
