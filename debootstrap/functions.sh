...
function do_apt_install_standard {
    do_apt_install eatmydata build-essential tmux flatpak vim neovim sudo squashfs-tools dnsmasq nginx-full
    ...
    do_apt_install task-ssh-server task-web-server task-xfce-desktop
    do_apt_install nginx-full wireguard
