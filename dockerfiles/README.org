...
**** Official
#+begin_src conf :mkdirp yes :tangle ./CUDA_UBUNTU_OFFICIAL/0_base/Dockerfile
...
**** Base image
#+begin_src conf :mkdirp yes :tangle ./CUDA_UBUNTU_OFFICIAL/1_install_packages/Dockerfile
  FROM 0_base
#+end_src
...
**** Official
#+begin_src conf :mkdirp yes :tangle ./CUDA_UBUNTU_OFFICIAL/5_libtorch/Dockerfile
  FROM 4_python
...
#+begin_src conf :mkdirp yes :tangle ./CUDA_UBUNTU/5_libtorch/Dockerfile
  ...
  RUN \
      ...
      && . "${HOME}/important_functions.sh" \
      && adown \
          'https://download.pytorch.org/libtorch/cu130/libtorch-shared-with-deps-2.9.1%2Bcu130.zip' \
          'libtorch.zip' \
          'fbd9c8f54d061600b464202b10a7c053f54ee286466dcf3bf890828a2973e5142c2fb382aae3db56ccca6b403e9021f28d9c43e1bae2085811e62aabd7ee34bd' \
          "${HOME}/libtorch.zip" \
      && cd "${HOME}" \
      && unzip './libtorch.zip' \
      && cd libtorch \
...
**** Official
#+begin_src conf :mkdirp yes :tangle ./CUDA_UBUNTU_OFFICIAL/6_pytorch/Dockerfile
  FROM 5_libtorch
...
******** Download and install the actual tools
#+begin_src conf :mkdirp yes :tangle ./CUDA_UBUNTU_OFFICIAL/6_pytorch/Dockerfile
  RUN \
      --mount=target=/root/SHA512SUM,type=cache \
      --mount=target=/root/TMP,type=cache \
...
#+begin_src emacs-lisp :results silent
  ...
  (async-shell-command "
      './.git.sh'
      git commit -m 'Shifting to python libtorch for nvidia cuda image'
