#!/bin/sh
cd "$(dirname -- "${0}")"
'./build_container.sh' 'CUDA_UBUNTU/0_base/Dockerfile'
...
'./build_container.sh' 'CUDA_UBUNTU/5_libtorch/Dockerfile'
'./build_container.sh' 'CPU/6_Common_python_data/Dockerfile'
'./build_container.sh' 'CUDA_UBUNTU/7_deep_learning/Dockerfile'
exit '0'
