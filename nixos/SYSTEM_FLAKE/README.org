...
#+begin_src sh :shebang #!/bin/sh :results output :mkdirp yes :tangle ./.git.sh
  ...
  NIXADD 'nixos/boot_config.nix'
  NIXADD 'nixos/configuration.nix'
  NIXADD 'nixos/environment.nix'
  NIXADD 'nixos/flake.nix'
  NIXADD 'nixos/hardware-configuration.nix'
  NIXADD 'nixos/i18n.nix'
  NIXADD 'nixos/network_config.nix'
  NIXADD 'nixos/services.nix'
