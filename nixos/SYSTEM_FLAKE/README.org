...
#+begin_src sh :shebang #!/bin/sh :results output :mkdirp yes :tangle ./.git.sh
  ...
  GITADD 'nixos/boot_config.nix'
  GITADD 'nixos/configuration.nix'
  GITADD 'nixos/environment.nix'
  GITADD 'nixos/hardware-configuration.nix'
  GITADD 'nixos/i18n.nix'
  GITADD 'nixos/network_config.nix'
  GITADD 'nixos/services.nix'
  GITADD 'README.org'
  GITADD 'setup.sh'
