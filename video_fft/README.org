...
#+begin_src rust :mkdirp yes :tangle ./src/main.rs
  ...
  mod videofn;
  use videofn::convert_encoded_video_to_raw as convert_encoded_video_to_raw;
  use videofn::get_file_hash as get_file_hash;
  use videofn::get_str_hash as get_str_hash;
...
#+begin_src sh :shebang #!/bin/sh :results output :mkdirp yes :tangle ./.git.sh
  ...
  git status ; git commit -m 'changed to use /dev/shm for temporary video location'
