  ...
  impl fft_video_64 {
      pub async fn save(&self, filename: &str) -> anyhow::Result<()> {
          ...
          if false {
              ...
              tokio::fs::File::create(filename).await?.write_all(bytes).await?;
          }
...
#+begin_src rust :mkdirp yes :tangle ./src/main.rs
  ...
  async fn main() -> anyhow::Result<()> {
      ...
      if true {
          ...
          tokio::task::spawn_blocking(move || fft_all_video_files_under_dir(/*target_dir: &str =*/ target_dir.as_str())).await?;
      }
