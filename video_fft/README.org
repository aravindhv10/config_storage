...
#+begin_src rust :mkdirp yes :tangle ./src/videofftstats.rs
  ...
  pub async fn eval_mean_sigma_slave(path_dir_base: &str) -> anyhow::Result<()> {
      ...
      let path_file_64bin_sigma = eval_sigma(/* target_dir: &str = */ path_dir_base, /* path_file_bin64_mean: &str = */ path_file_64bin_mean.as_str())?;
  ...
  pub fn eval_mean_sigma(path_dir_base: &str) -> anyhow::Result<()> {
      ...
      rt.block_on(async {tokio::join!(eval_mean_sigma_slave(path_dir_base: &str));});
