...
#+begin_src sh :shebang #!/bin/sh :results output :mkdirp yes :tangle ./GIT/work.sh
  ...
  wait
  git add '--pathspec-from-file=./GIT/git_add.txt'
  git status
#+end_src
...
** git add
coding_setup/test.sh
#+begin_src conf :mkdirp yes :tangle ./GIT/git_add.txt
  coding_setup/1_download_model.sh
  coding_setup/2_start_server.sh
  coding_setup/3_download_lsp.sh
  coding_setup/.config/helix/languages.toml
  coding_setup/README.org
  compress.sh
  ...
  emacs_new/setup.sh
  emacs_new/snippets/org-mode/conf
  emacs_new/snippets/org-mode/myelisp
  emacs_new/snippets/org-mode/nix
  emacs_new/snippets/org-mode/py
  emacs_new/snippets/org-mode/rust
  emacs_new/snippets/org-mode/sh
  emacs_new/snippets/org-mode/sql
  emacs_new/variables.el
  emacs_new/variables_post.el
  .gitignore
  GIT.org
  GIT/pull.sh
  home_config/Cargo.toml
  home_config/src/fish_config.fish
  home_config/src/helix_config.toml
  home_config/src/helix_languages.toml
  home_config/src/main.rs
  home_config/src/mysync.rs
  home_config/src/shrc
...
#+begin_src conf :mkdirp yes :tangle ./GIT/rm.txt
  ...
  debootstrap/README.org~
  dnsmasq/README.org~
  dockerfiles/CPU/6_Common_python_data/Dockerfile
  dockerfiles/#README.org#
  dockerfiles/.#README.org
  ...
  GIT.org~
  helix/README.org~
  home_config/#main.org#
  home_config/.#main.org
  home_config/src/helix_languages.toml~
  #main.org#
  .#main.org
  .main.org.~undo-tree~
  nixos/HOME/2/#main.org#
  nixos/HOME/2/README.org~
  README.org~
  RUST/#compile.org#
  RUST/.#compile.org
  RUST/compile.org~
...
#+begin_src conf :mkdirp yes :tangle ./GIT/gitignore.txt
  ...
  dockerfiles/CPU/6_common_python_data/build/
  dockerfiles/CPU/6_common_python_data/important_functions.sh
  dockerfiles/CPU/7_deep_learning/build/
  dockerfiles/CPU/7_deep_learning/important_functions.sh
  dockerfiles/CPU/7_deep_learning/run_cpu_7_deep_learning.sh
  dockerfiles/CPU/7_deep_learning/run_cpu.sh
